  ...
  return (
    <>
      ...
      <footer className="container-fluid footer">
        <ul className="nav justify-content-center border-bottom">
          <li className="nav-item">
            <a href="#" className="nav-link">
              <p class="text-secondary"> <AiOutlineWhatsApp />
              </p>
            </a>
          </li>
        ...
        <p className="text-center text-body-dark">&copy; Copyright © 2023 Con fines Educativos (EMPRENDIMIENTO).</p>
      </footer>
